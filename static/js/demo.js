...
//          format: 'H:mm',    // use this format if you want the 24hours timepicker
    ...
    initCharts: function(){
        ...
        dataRoundedLineChart = {
            labels: ['Red', 'Xia','Tec', 'App', 'Sam', 'Viv', 'Inf'],
            series: [
                [35, 114, 64, 55, 80, 84, 38]
            ]
        };
        ...
        optionsRoundedLineChart = {
            ...
            low: 0,
            high: 140, // creative tim: we recommend you to set the high sa the biggest value + something for a better look
            chartPadding: { top: 0, right: 0, bottom: 0, left: 0},
            showPoint: false
        }
        ...
        dataStraightLinesChart = {
          labels: ['Red','Xia','App', 'Tec', 'Sam', 'Viv', 'Inf'],
          series: [
            [4.5, 4.8, 4, 4.2, 4.6, 4, 3.8]
          ]
        };
        ...
        dataColouredRoundedLineChart = {
          labels: ['Red','Xia','App', 'Tec', 'Sam', 'Viv', 'Inf','Opp','Hon','Son','Dra','Ite','LG','Vgo'], 
          series: [
            [35, 114, 64, 55, 80, 84, 38,77,65,110,56,59,100,94]
          ]
        };
        ...
        dataColouredBarsChart = {
          labels: ['Red','Xia','App', 'Tec', 'Sam', 'Viv', 'Inf','Opp','Hon','Son','Dra','Ite','LG','Vgo'],
          series: [
            [4.5, 4.8, 4, 4.2, 4.6, 5, 3.8,4.5,4,4.4,4.9,4.5,3.9,4]
        ...
        var dataMultipleBarsChart = {
          labels: ['Red','Xia','App', 'Tec', 'Sam', 'Viv', 'Inf','Opp','Hon','Son','Dra','Ite','LG','Vgo'], 
          series: [
            [16.6, 9.6, 1.0, 7.3, 15.5, 4.4, 14,5,10,5,14,5,6,7],
            [5, 5.5, 1, 3, 7, 6, 9, 2.5, 7.4, 8,10,5,8,3]
          ]
        };
